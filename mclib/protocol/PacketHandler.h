...
public:
	...
	virtual void HandlePacket(login::in::DisconnectPacket* packet) {} // 0x00
	virtual void HandlePacket(login::in::EncryptionRequestPacket* packet) {} // 0x01
	virtual void HandlePacket(login::in::LoginSuccessPacket* packet) {} // 0x02
	virtual void HandlePacket(login::in::SetCompressionPacket* packet) {} // 0x03

	// Status protocol state
	virtual void HandlePacket(status::in::ResponsePacket* packet) {} // 0x00
	virtual void HandlePacket(status::in::PongPacket* packet) {} // 0x01
