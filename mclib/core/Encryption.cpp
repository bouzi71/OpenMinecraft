...
private:
	...
	login::out::EncryptionResponsePacket* m_ResponsePacket;
	...
	bool Initialize(const std::string& publicKey, const std::string& verifyToken)
	{
		...
		m_ResponsePacket = new login::out::EncryptionResponsePacket(encryptedSS, encryptedToken);
		return true;
	}
...
public:
	...
	login::out::EncryptionResponsePacket* GenerateResponsePacket() const
	{
...
login::out::EncryptionResponsePacket* EncryptionStrategyAES::GenerateResponsePacket() const
{
